...
class UploadImagem extends StatefulWidget {
  ...
  const UploadImagem({Key? key, required this.onSelecionaImagem})
      : super(key: key);
    ...
    if (this.imagem == null) {
      return [
        ...
        Text(
          ...
          style: TextStyle(color: ColorUtil.COR_03),
        ),
      ];
    } else {
      return [Image.memory(this.imagem!, height: 200)];
    }
  }
                      ...
                      mainAxisAlignment: MainAxisAlignment.center,                      
                        children: [ 
                          Expanded(
                            child: GestureDetector (
                              onTap: () async {
                                await this.abrirGaleriaouCamera(ImageSource.camera);
